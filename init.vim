...
autocmd FileType python nnoremap <leader>x :0,$!~/.config/nvim/env/bin/python -m yapf<CR>
nnoremap <silent> <leader><leader> :noh<CR>
nnoremap <Tab> :bnext<CR>
nnoremap <S-Tab> :bprevious<CR>
nnoremap <leader>pa :set paste!<CR>
nnoremap <leader>c gd
...
" 设置快捷键
nnoremap ccs :cs find s <C-R>=expand("<cword>")<CR><CR>
nnoremap ccg :cs find g <C-R>=expand("<cword>")<CR><CR>
nnoremap ccc :cs find c <C-R>=expand("<cword>")<CR><CR>
nnoremap cct :cs find t <C-R>=expand("<cword>")<CR><CR>
nnoremap cce :cs find e <C-R>=expand("<cword>")<CR><CR>
nnoremap ccf :cs find f <C-R>=expand("<cfile>")<CR><CR>
nnoremap cci :cs find i <C-R>=expand("<cfile>")<CR><CR>
nnoremap ccd :cs find d <C-R>=expand("<cword>")<CR><CR>
